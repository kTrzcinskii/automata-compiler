...
func TestNewPushdownAutomatonCompiler(t *testing.T) {
	tokens := []lexer.Token{
	...
	result := NewPushdownAutomatonCompiler(tokens)
	expected := PushdownAutomatonCompiler{
...
func TestCompilePA(t *testing.T) {
	data := []struct {
		name           string
		tokens         []lexer.Token
		expected       *automaton.PushdownAutomaton
	...
	}{
		{
			...
			[]lexer.Token{
				...
				{Type: lexer.SymbolToken, Value: "symbol4", Line: 5},
				...
				{Type: lexer.SymbolToken, Value: "symbol4", Line: 7},
			...
			&automaton.PushdownAutomaton{
				...
				Symbols: map[string]automaton.Symbol{
					automaton.InputEndSymbol.Name:   automaton.InputEndSymbol,
					automaton.StackStartSymbol.Name: automaton.StackStartSymbol,
					"symbol1":                       {Name: "symbol1"},
					"symbol2":                       {Name: "symbol2"},
					"symbol3":                       {Name: "symbol3"},
					"symbol4":                       {Name: "symbol4"},
				},
				Input:   []string{"symbol2", "symbol1", "symbol4", "symbol3", automaton.InputEndSymbol.Name},
				InputIt: 0,
				Stack:   []string{automaton.StackStartSymbol.Name},
				Transitions: map[automaton.PATransitionKey]automaton.PATransitionValue{
					{StateName: "qState", InputSymbolName: "symbol1", StackSymbolName: "symbol2"}: {StateName: "qState2", StackSymbolNames: []string{"symbol3", "symbol4"}},
				},
			},
			"",
		},
		{
			"transitions that put on stack different number of elements",
			[]lexer.Token{
				// States
				{Type: lexer.StateToken, Value: "qState", Line: 1},
				{Type: lexer.SemicolonToken, Value: ";", Line: 2},
			...
			&automaton.PushdownAutomaton{
				...
				Input:   []string{"symbol2", automaton.InputEndSymbol.Name},
				InputIt: 0,
				Stack:   []string{automaton.StackStartSymbol.Name},
				Transitions: map[automaton.PATransitionKey]automaton.PATransitionValue{
					{StateName: "qState", InputSymbolName: "symbol1", StackSymbolName: "symbol1"}: {StateName: "qState", StackSymbolNames: []string{"symbol2", "symbol2", "symbol2", "symbol2"}},
					{StateName: "qState", InputSymbolName: "symbol2", StackSymbolName: "symbol2"}: {StateName: "qState", StackSymbolNames: []string{}},
				},
			},
			"",
		},
		...
		{
			"undefined input symbol in left side transition",
			[]lexer.Token{
				// States
				{Type: lexer.StateToken, Value: "qState", Line: 1},
				{Type: lexer.StateToken, Value: "qState2", Line: 1},
			...
			nil,
			"[Line 6] undefined input symbol symbol4 used in transition function left side",
		},
		{
			"undefined stack symbol in left side transition",
			[]lexer.Token{
				// States
				{Type: lexer.StateToken, Value: "qState", Line: 1},
				{Type: lexer.StateToken, Value: "qState2", Line: 1},
			...
			nil,
			"[Line 6] undefined stack symbol symbol4 used in transition function left side",
		},
		{
		...
		},
		{
			...
			nil,
			"[Line 6] undefined stack symbol symbol30 used in transition function right side",
		},
		{
			"invalid token after state in right side transition",
			[]lexer.Token{
				// States
				{Type: lexer.StateToken, Value: "qState", Line: 1},
				{Type: lexer.StateToken, Value: "qState2", Line: 1},
			...
			nil,
			"[Line 6] invalid token type, expected one of: RightParenToken, CommaToken, got: SymbolToken",
		},
		{
		...
		},
		{
			...
			[]lexer.Token{
				...
				{Type: lexer.SemicolonToken, Value: ";", Line: 6},
				// Input
				{Type: lexer.StackStartToken, Value: automaton.StackStartSymbol.Name, Line: 7},
			},
			nil,
			"[Line 7] invalid token type, expected: SemicolonToken or SymbolToken, got: StackStartToken",
		},
		{
		...
		{
			"user cannot declare StactStartSymbol in symbol section",
			[]lexer.Token{
				// States
				{Type: lexer.StateToken, Value: "qState", Line: 1},
				{Type: lexer.SemicolonToken, Value: ";", Line: 2},
				...
				{Type: lexer.SemicolonToken, Value: ";", Line: 4},
				// Symbols
				{Type: lexer.StackStartToken, Value: "}", Line: 5},
			},
			nil,
			"[Line 5] invalid token type, expected: SymbolToken or SemicolonToken, got: StackStartToken",
		},
		{
			"user cannot declare InputEndToken in symbol section",
			[]lexer.Token{
				// States
				{Type: lexer.StateToken, Value: "qState", Line: 1},
				{Type: lexer.SemicolonToken, Value: ";", Line: 2},
				...
				{Type: lexer.SemicolonToken, Value: ";", Line: 4},
				// Symbols
				{Type: lexer.InputEndToken, Value: "{", Line: 5},
			},
			nil,
			"[Line 5] invalid token type, expected: SymbolToken or SemicolonToken, got: InputEndToken",
		},
	}
	for _, d := range data {
		t.Run(d.name, func(t *testing.T) {
			pac := NewPushdownAutomatonCompiler(d.tokens)
			result, err := pac.Compile()
